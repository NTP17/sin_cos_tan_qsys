//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" LPM_PIPELINE=3 LPM_REPRESENTATION="UNSIGNED" LPM_WIDTHA=36 LPM_WIDTHB=36 LPM_WIDTHP=32 LPM_WIDTHS=1 clock dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
`endif
	...
	wire [35:0]    dataa_wire;
	wire [35:0]    datab_wire;
	wire [71:0]    result_wire;
	...
	// synopsys translate_on
	always @(posedge clock)
		result_extra0_reg <= result_wire[71:40];
